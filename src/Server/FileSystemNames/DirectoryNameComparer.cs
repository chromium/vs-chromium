...
namespace VsChromium.Server.FileSystemNames {
  public class DirectoryNameComparer : IComparer<DirectoryName>, IEqualityComparer<DirectoryName> {
    public static readonly DirectoryNameComparer Instance = new DirectoryNameComparer();
    ...
    public int GetHashCode(DirectoryName x) {
