...
namespace VsChromium.Features.ToolWindows.SourceExplorer {
  ...
  public class GotoNextLocationCommandHandler : PackagePriorityCommandHandlerBase {
    ...
    public override CommandID CommandId { get { return new CommandID(VSConstants.GUID_VSStandardCommandSet97, (int)VSConstants.VSStd97CmdID.NextLocation); } }
  ...
  public class GotoPreviousLocationCommandHandler : PackagePriorityCommandHandlerBase {
    ...
    public override CommandID CommandId { get { return new CommandID(VSConstants.GUID_VSStandardCommandSet97, (int)VSConstants.VSStd97CmdID.PreviousLocation); } }
